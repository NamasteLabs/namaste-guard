...
![NamasteGuard Settings JSON](src/assets/img/namaste-guard-settings-json.png)
...
![NamasteGuard Settings UI](src/assets/img/namaste-guard-settings-ui.png)
