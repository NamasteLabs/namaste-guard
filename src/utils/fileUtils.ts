...
/**
 * Retrieves the full path of a file in the workspace's `.namaste-guard` directory, creating the directory if necessary.
...
export function getFilePath(
    ...
    const dir = path.join(rootFolder, '.namaste-guard'); // Ensure .namaste-guard is created in the root folder
