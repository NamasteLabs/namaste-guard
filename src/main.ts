...
/**
 * Activates the NamasteGuard extension.
...
export function activate(context: vscode.ExtensionContext) {
    ...
    const scanCommand = vscode.commands.registerCommand('namaste-guard.startScan', async () => {
...
/**
 * Deactivates the NamasteGuard extension.
